# 用法：
#  單張圖片：python3 paddle_batch_v3_no_orientation.py --image 圖片名稱 --outdir out --lang ch --to_pagexml
#  批量處理：python3 paddle_batch_v3_no_orientation.py --input_dir 文件夾名稱 --outdir out --lang ch --to_pagexml
