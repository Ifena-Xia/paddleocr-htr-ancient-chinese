# 用法：
#  只做分割：python3 exp_paddle_v3_initial.py --image 圖片名稱 --outdir out --lang ch --to_pagexml
#  分割+文字：python3 exp_paddle_v3_initial.py --image 圖片名稱 --outdir out --lang ch --to_pagexml --with_rec
