# 用法：
#  單張圖片：python3 paddle_batch_v3_no_orientation.py --image 190_ef531_default.jpg --outdir out --lang ch --to_pagexml
#  批量處理：python3 paddle_batch_v3_no_orientation.py --input_dir images --outdir out --lang ch --to_pagexml
    ...
    if ocr_instance is None:
        ...
        try:
            ...
            ocr_instance = PaddleOCR(
                lang=lang,
                use_doc_orientation_classify=False,  # Turning it on would worsen the result
                use_doc_unwarping=False,             # The page is flat enough
                use_textline_orientation=False,      # Turning it on would worsen the result
                text_det_limit_side_len=1200,        # ≈ det_limit_side_len
                text_det_thresh=0.3,                 # ≈ det_db_thresh
                text_det_box_thresh=0.4,             # ≈ det_db_box_thresh
                text_det_unclip_ratio=1.6           # ≈ det_db_p_ratio / unclip_ratio   
            )
